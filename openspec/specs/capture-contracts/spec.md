...
Passive cross-bounded-context contract types in `AIX.Documents.Contracts` enable Documents to integrate with Metadata validation without referencing Metadata domain types.
