# Capture Metadata Attachment

## Purpose

The `Document` aggregate holds version-scoped captured metadata while in Draft; metadata is immutable after Complete; changes emit domain events suitable for audit and downstream projections.
